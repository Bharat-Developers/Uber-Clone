    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
        ...
        <div className="p-4">
          ...
          <label htmlFor="aadhar" className="block text-gray-700 mb-2">Enter Aadhaar Number</label>
          <input
            type="text"
            id="aadhar"
        ...
        <Link href="/Driver/Signup/Documents" > <button className="bg-black text-white py-2 px-4 rounded w-full" onClick={handleContinue}>Continue</button></Link>
        </div>
      </div>
    </div>
  );
