    ...
    return (
        <div className={styles.container}>
            <div className={styles.text}>
                ...
                <br />
                <br />
                <Image src='/img.jpg' height={1400} width={1400} alt='img' />
            </div>
            <br />
            <div className={styles.flexbox}>
                <div className={styles.box}>
                    <Image src='/calendar.jpg' height={25} width={25} alt='calendar' />
                    <br />
                ...
                <div className={styles.box}>
                    <Image src='/money.jpg' height={25} width={25} alt='money' />
                    <br />
